...
$commands= @(
    ...
    'cmd.exe /C winget.exe install --id "LeNgocKhoa.Laragon" --exact --source winget --accept-source-agreements --disable-interactivity --silent --accept-package-agreements --force --location "D:\Laragon"',
